...
import { PLAYER_RADIUS, GRAVITY } from "./constants.js";
...
export const LEVEL_DATA = levelJson.platforms.map((p) =>
...
export function buildLevel(clearEnemiesFn, populateEnemiesFn) {
